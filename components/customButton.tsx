...
const CustomButton = ({
  ...
  return (
    <TouchableOpacity
      onPress={onPress}
      disabled={disabled}
      className={`flex flex-row items-center justify-center rounded-full p-3 shadow-md shadow-neutral-400/70 dark:shadow-dark-border ${getBgVariantStyle(bgVariant)} ${disabled ? "opacity-50" : ""} ${className}`}
