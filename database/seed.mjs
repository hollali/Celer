...
const drivers = [
  {
    ...
    car_seats: 4, rating: 4.8, vehicle_type: "Economy",
    current_latitude: 5.6037, current_longitude: -0.1870,
    phone: "+233241234567", email: "kwame.asante@email.com",
  },
  {
    ...
    car_seats: 4, rating: 4.7, vehicle_type: "Economy",
    current_latitude: 5.6100, current_longitude: -0.1900,
    phone: "+233241234568", email: "ama.boateng@email.com",
  },
  {
    ...
    car_seats: 4, rating: 4.6, vehicle_type: "Comfort",
    current_latitude: 5.5800, current_longitude: -0.1800,
    phone: "+233241234569", email: "kofi.mensah@email.com",
  },
  {
    first_name: "Esi", last_name: "Owusu",
    ...
    car_seats: 4, rating: 4.5, vehicle_type: "Economy",
    current_latitude: 5.5600, current_longitude: -0.2000,
    phone: "+233241234570", email: "esi.owusu@email.com",
  },
  {
    first_name: "Yaw", last_name: "Adomako",
    ...
    car_seats: 4, rating: 4.9, vehicle_type: "Premium",
    current_latitude: 5.6200, current_longitude: -0.1750,
    phone: "+233241234571", email: "yaw.adomako@email.com",
  },
  {
    ...
    car_seats: 6, rating: 4.4, vehicle_type: "Van",
    current_latitude: 5.5950, current_longitude: -0.1950,
    phone: "+233241234572", email: "abena.osei@email.com",
  },
  {
    first_name: "Nana", last_name: "Agyeman",
    ...
    car_seats: 2, rating: 4.8, vehicle_type: "Economy",
    current_latitude: 5.6150, current_longitude: -0.1700,
    phone: "+233241234573", email: "nana.agyeman@email.com",
  },
  {
    first_name: "Akua", last_name: "Mensah",
    ...
    car_seats: 4, rating: 4.3, vehicle_type: "Comfort",
    current_latitude: 5.5700, current_longitude: -0.1850,
    phone: "+233241234574", email: "akua.mensah@email.com",
  },
  {
    first_name: "Kojo", last_name: "Frimpong",
    profile_image_url: "https://randomuser.me/api/portraits/men/9.jpg",
    car_image_url: "https://images.unsplash.com/photo-1552519507-da3b142c6e3d?w=800",
    car_seats: 4, rating: 4.7, vehicle_type: "Economy",
    current_latitude: 5.5900, current_longitude: -0.2100,
    phone: "+233241234575", email: "kojo.frimpong@email.com",
  },
  {
    first_name: "Adwoa", last_name: "Badu",
    profile_image_url: "https://randomuser.me/api/portraits/women/10.jpg",
    car_image_url: "https://images.unsplash.com/photo-1549399542-7e3f8b79c341?w=800",
    car_seats: 4, rating: 4.2, vehicle_type: "Economy",
    current_latitude: 5.6050, current_longitude: -0.1650,
    phone: "+233241234576", email: "adwoa.badu@email.com",
  },
  {
    first_name: "Kwesi", last_name: "Appiah",
    profile_image_url: "https://randomuser.me/api/portraits/men/11.jpg",
    car_image_url: "https://images.unsplash.com/photo-1503376780353-7e6692767b70?w=800",
    car_seats: 5, rating: 4.6, vehicle_type: "Premium",
    current_latitude: 5.5850, current_longitude: -0.1950,
    phone: "+233241234577", email: "kwesi.appiah@email.com",
  },
  {
    first_name: "Afi", last_name: "Dzagah",
    profile_image_url: "https://randomuser.me/api/portraits/women/12.jpg",
    car_image_url: "https://images.unsplash.com/photo-1544636331-e26879cd4d9b?w=800",
    car_seats: 4, rating: 4.5, vehicle_type: "Comfort",
    current_latitude: 5.6100, current_longitude: -0.1550,
    phone: "+233241234578", email: "afi.dzagah@email.com",
  },
];
...
async function seed() {
  ...
  try {
    ...
    const listing = await sql`SELECT id, first_name, last_name, rating, vehicle_type, car_seats, current_latitude, current_longitude FROM drivers ORDER BY id`;
    for (const d of listing) {
      console.log(`  ${d.id}. ${d.first_name} ${d.last_name} | ${d.vehicle_type} | ${d.car_seats} seats | rating: ${d.rating} | (${d.current_latitude}, ${d.current_longitude})`);
    }
  } catch (e) {
